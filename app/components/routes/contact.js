...
export default class Contact extends React.Component {
  ...
  render() {
    return (
      <div>
        <div style={{minHeight: 'calc(100vh - 320px)'}} className="container">
          <h1 className="center-align"><em style={{color: '#1db7a9'}}>Ready to Reach Out?</em></h1>
          <div style={{backgroundColor: '#d9ead3'}} className="row">
